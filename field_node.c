...
static void recv_from_broadcast(struct broadcast_conn *broadcast, const linkaddr_t *from)
{
	//if message recieved set b_mess = true
	b_mess = true;
	//struct unicast_conn *bc_uc = (struct unicast_conn *)broadcast;
}
...
//static struct broad_callbacks bc_callback = {};  //error

static struct unicast_conn uc;

static struct unicast_callbacks uc_callback = {recv_from_broadcast, recv_uc};
